              ...
              <div class="col-xl-4 col-md-4 ecommerce-chart daily-visitors">
                ...
                <div class="progress-value">
                  ...
                  <div class="progress bg-light-primary">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 70%" aria-valuenow="10"
                ...
                <div class="progress-value">
                  ...
                  <div class="progress bg-light-secondary">
                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 70%" aria-valuenow="10"
                      aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-xxl-5 col-xl-4 col-lg-4 box-col-4">
        <div class="card product-card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex">
              <div class="card-product"> <a href="product.html"> <span> <img
              ...
              <table class="table display" id="invoice" style="width:100%">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/user/1.png" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/user/2.png" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/user/3.png" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/user/4.png" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <ul class="track-order">
              <li>
                <div class="d-flex">
                  <div class="flex-shrink-0 bg-primary"><img src="{{ asset('') }}assets/images/dashboard-2/product/4.png"
                      alt=""></div>
                  <div class="flex-grow-1">
              ...
              <li>
                <div class="d-flex">
                  <div class="flex-shrink-0 bg-secondary"><img src="{{ asset('') }}assets/images/dashboard-2/product/5.png"
                      alt=""></div>
                  <div class="flex-grow-1">
                    <div class="d-flex justify-content-between"> <a href="product.html">
                        <h6>Order Packed</h6>
              ...
              <li>
                <div class="d-flex">
                  <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/6.png" alt="">
                  </div>
                  <div class="flex-grow-1">
                    <div class="d-flex justify-content-between"> <a href="product.html">
                        <h6>On the way</h6>
              ...
              <li>
                <div class="d-flex">
                  <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/7.png" alt="">
                  </div>
                  <div class="flex-grow-1">
                    <div class="d-flex justify-content-between"> <a href="product.html">
                        <h6>Product Deliverd</h6>
                        <p class="text-truncate">Our courier partner will deliver our stuff on July 3, 2024...</p>
                      </a></div>
                  </div>
                </div>
              </li>
              ...
              <table class="table display" id="report" style="width:100%">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/8.png"
                            alt=""></div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                            <h6>MacBook Pro</h6>
                          </a></div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/9.png"
                            alt=""></div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/10.png"
                            alt=""></div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
                            <h6>Apple Watch</h6>
                          </a></div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="flex-shrink-0"><img src="{{ asset('') }}assets/images/dashboard-2/product/11.png"
                            alt=""></div>
                        <div class="flex-grow-1 ms-3"><a href="list-products.html">
