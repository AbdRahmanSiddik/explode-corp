<x-admin>
  <x-slot:title>Admin | Produk List</x-slot:title>
            ...
            <table class="table table-borderless text-nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="order-detail.html" class="btn btn-outline-secondary btn-sm rounded-2"
                      data-tooltip="tooltip" title="Details"><i class="far fa-eye"></i></a>
                  </td>
                </tr>
                <tr>
                  <td><span class="table-list-code">#28VR5K59</span></td>
