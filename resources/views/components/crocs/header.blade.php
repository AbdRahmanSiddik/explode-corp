      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          ...
          <div class="onhover-show-div notification-dropdown">
            ...
            <div class="d-flex align-items-center"><img src="{{ asset('') }}assets/images/dashboard/user/5.png"
                alt="">
            ...
            <div class="d-flex align-items-center"><img src="{{ asset('') }}assets/images/dashboard/user/6.png"
                alt="">
              <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                  <h5>
            ...
            <ul>
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="{{ asset('') }}assets/images/user/3.jpg"
                      alt=""></div>
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="{{ asset('') }}assets/images/user/6.jpg"
                      alt=""></div>
                  <div class="flex-grow-1">
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="{{ asset('') }}assets/images/user/10.jpg"
                      alt=""></div>
                  <div class="flex-grow-1">
