              ...
              <ul class="header-top-list">
                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#bed7d0d8d1fedbc6dfd3ced2db90ddd1d3"><i
                    ...
                    <span class="__cf_email__"
                      data-cfemail="99f0f7fff6d9fce1f8f4e9f5fcb7faf6f4">[email&#160;protected]</span></a></li>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
          ...
          <div class="offcanvas-body">
            ...
            <div class="nav-right">
              ...
              <a class="nav-right-link" href="track-order.html"><i class="fal fa-truck-fast"></i> Track My
                Order</a>
            </div>
          </div>
        </div>
