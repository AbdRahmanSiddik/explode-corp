                ...
                <ul class="nav nav-pills mt-40 mb-50" id="item-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="item-tab1" data-bs-toggle="pill"
                      data-bs-target="#pill-item-tab1" type="button" role="tab" aria-controls="pill-item-tab1"
                      aria-selected="true">Medicine</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="item-tab2" data-bs-toggle="pill" data-bs-target="#pill-item-tab2"
                      type="button" role="tab" aria-controls="pill-item-tab2" aria-selected="false">Beauty
                      Care</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="item-tab3" data-bs-toggle="pill" data-bs-target="#pill-item-tab3"
                      type="button" role="tab" aria-controls="pill-item-tab3"
                      aria-selected="false">Healthcare</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="item-tab4" data-bs-toggle="pill" data-bs-target="#pill-item-tab4"
                      type="button" role="tab" aria-controls="pill-item-tab4" aria-selected="false">Baby &
                      Mom Care</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="item-tab5" data-bs-toggle="pill" data-bs-target="#pill-item-tab5"
                      type="button" role="tab" aria-controls="pill-item-tab5" aria-selected="false">Food &
                      Nutrition</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="item-tab6" data-bs-toggle="pill" data-bs-target="#pill-item-tab6"
                      type="button" role="tab" aria-controls="pill-item-tab6" aria-selected="false">Medical
                      Equipments</button>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="product-img">
                      ...
                      <div class="product-action-wrap">
                        <div class="product-action">
                          ...
                          <a href="#" data-bs-placement="top" data-tooltip="tooltip" title="Add To Compare"><i
          ...
          <div class="product-item">
            ...
            <div class="product-content">
              ...
              <div class="product-bottom">
                ...
                <button type="button" class="product-cart-btn" data-bs-placement="left" data-tooltip="tooltip"
                  title="Add To Cart">
                  <i class="far fa-shopping-bag"></i>
                </button>
              </div>
